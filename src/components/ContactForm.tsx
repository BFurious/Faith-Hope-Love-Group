...
export default function ContactForm({
    ...
    const companyEmail = 'faithopelovegroup@gmail.com'
        ...
        return (
            ...
            >
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                    Your message has been sent successfully. One of our licensed insurance specialists will contact you within 24 hours.
                </p>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all duration-300 ${errors.name
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all duration-300 ${errors.email
                                    ? 'border-red-300 focus:border-red-500 focus:ring-red-100'
                                    : 'border-gray-200 focus:border-blue-500 focus:ring-blue-100'
                                    }`}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all duration-300 ${errors.phone
                                    ? 'border-red-300 focus:border-red-500 focus:ring-red-100'
                                    : 'border-gray-200 focus:border-blue-500 focus:ring-blue-100'
                                    }`}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <select
                                ...
                                className={`w-full pr-4 py-4 pl-4 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all duration-300 ${errors.bestTime
                                    ? 'border-red-300 focus:border-red-500 focus:ring-red-100'
                                    : 'border-gray-200 focus:border-blue-500 focus:ring-blue-100'
                                    }`}
                            >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <textarea
                                ...
                                className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all duration-300 resize-none ${errors.message
                                    ? 'border-red-300 focus:border-red-500 focus:ring-red-100'
                                    : 'border-gray-200 focus:border-blue-500 focus:ring-blue-100'
                                    }`}
