...
const services = [
  {
    ...
    description:
      "Comprehensive accident and sickness insurance plans designed to provide financial protection and peace of mind for individuals and families.",
    features: [
  ...
  },
  {
    ...
    description:
      "Tailored Property and Casualty (P&C) insurance solutions for both individuals and businesses to protect their assets and manage liability risks.",
    features: [
  ...
  },
  {
    ...
    description:
      "Comprehensive life insurance solutions designed to provide financial security and peace of mind for you and your loved ones.",
    features: [
      "Term Life Insurance",
  ...
  },
  {
    ...
    features: [
      "Free ACA Marketplace Assistance",
      "Subsidy & Tax Credit Maximization",
  ...
  },
  {
    ...
    features: [
      "Precise written translations (French ↔ English)",
      "Basic interpretation assistance",
      "Document and form translations",
    ...
    >
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {(showLimited ? services.slice(0, 5) : services).map(
            (service, index) => {
                  ...
                  <div className="bg-white rounded-2xl p-6 md:p-8 shadow-soft hover:shadow-medium transition-all duration-300 h-full border border-gray-100 flex flex-col">
                    ...
                    <Link
                      href={`/services#${service.title
                        .toLowerCase()
                        .replace(/\s+/g, "-")}`}
                      className={`inline-flex items-center gap-2 font-semibold transition-colors duration-300 mt-auto ${
                        service.color === "primary"
              ...
              <Link href="/services">
                <div className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-2xl p-6 md:p-8 shadow-soft hover:shadow-medium transition-all duration-300 h-full border border-primary-200 flex flex-col items-center justify-center text-white text-center group-hover:scale-105">
                  ...
                  <p className="text-primary-100 mb-6 leading-relaxed">
                    Discover our complete range of insurance solutions and
                    specialized services designed to protect what matters most.
                  </p>
