...
import { MessageCircle, Phone, Mail, MapPin, Star, CheckCircle2 } from 'lucide-react'
...
export default function HomeContact() {
    ...
    return (
        <section id="contact" className="section-padding bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
            <div className="container-custom">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        ...
                        >
                            <h4 className="font-bold text-gray-900 mb-4">Why Choose Faith Hope Love Group?</h4>
