...
const CTA_OPTIONS = [
  {
    ...
    description:
      "Protect what matters most. Use our secure form to request a no-obligation quote in minutes. Our licensed agent will help you compare your options and find the coverage that fits your needs and budget.",
  ...
  },
  {
    ...
    description:
      "Have questions about your insurance options? Book a free, one-on-one consultation with one of our trusted advisors. We're here to help you navigate your coverage choices and make informed decisions.",
  ...
  },
  {
    ...
    description:
      "Our Georgia-based agent are standing by to help you find the right protection. Call us today or click below to get started with expert advice tailored to your situation.",
...
const INSURANCE_TYPES = [
  {
    ...
    href: "/services#property-casualty-insurance",
  },
  {
    name: "Home Insurance",
    icon: "🏠",
  ...
  },
  {
    ...
    href: "/services#accident-sickness-insurance",
  },
  {
    name: "Travel Insurance",
    icon: "✈️",
    description: "Safe travels with peace of mind",
...
const BackgroundElements = () => (
  <div className="absolute inset-0">
    ...
    <div
      className="absolute bottom-20 left-20 w-96 h-96 bg-purple-200 rounded-full opacity-10 blur-3xl animate-pulse"
...
const AnimatedInsuranceTypeCard = ({
  type,
  index,
  inView,
}: {
  type: (typeof INSURANCE_TYPES)[0];
  index: number;
  inView: boolean;
}) => (
  <motion.div
  ...
  >
    ...
    <div>
      ...
      <p className="text-sm text-gray-600">
        Experience the difference with our dedicated team and comprehensive
        coverage options.
      </p>
    </div>
  </motion.div>
    ...
    >
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            {/* Contact Cards */}
            <ContactInfo items={CONTACT_INFO} delay={1.6} />

            {/* CTA Options */}
            <CTACards options={CTA_OPTIONS} delay={1.4} />
          </motion.div>
        </div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                ...
                comprehensive coverage that gives you peace of mind.
              </p>
            </div>
