...
const footerSections = [
  {
    ...
    links: [
      ...
      { name: "Business (Commercial) Insurance", href: "/services" },
      { name: "Obamacare", href: "/services" },
      { name: "Medicare", href: "/services" },
...
export default function Footer() {
  ...
  const handleNewsletterSignup = async (e: React.FormEvent) => {
    ...
    try {
      const response = await emailService.sendNewsletterSubscription(
        newsletterEmail
      );
            ...
            <div className="space-y-4 md:space-y-6 px-4 lg:px-0">
              ...
              >
                <div className="relative h-16 md:h-18 w-28 md:w-28 rounded-xl bg-white flex items-center justify-center px-1 py-2 md:px-2 shadow-lg">
                  <Image
                    src="/faith_logo.png"
                    alt="Faith Hope Love Group Logo"
                    fill
                    priority
              ...
              <p className="text-gray-300 leading-relaxed text-sm md:text-base max-w-md">
                ...
                insurance solutions built on hope, faith, and love. Your trusted
              ...
              <div className="space-y-2 md:space-y-3">
                ...
                >
                  ...
                  <span className="text-sm md:text-base">care@faholog.com</span>
                </div>
            ...
            <div className="text-center md:text-left md:flex md:items-center md:justify-between">
              <div className="mb-4 md:mb-0">
                ...
                <p className="text-gray-400 text-sm md:text-base max-w-md">
                  Get insurance tips, safety advice, and exclusive offers
                  delivered to your inbox.
                </p>
              </div>
              <form
                onSubmit={handleNewsletterSignup}
                className="flex flex-col sm:flex-row gap-3 md:max-w-md md:w-full md:ml-8"
              >
                <input
                  type="email"
