    ...
    <>
      ...
      <motion.header
        ...
        className={cn(
          ...
          isScrolled ? "bg-white/95 backdrop-blur-lg shadow-medium" : "bg-white"
        )}
      >
        <nav className="container-custom">
          <div className="flex items-center justify-between h-20">
            ...
            >
              <Link href="/#hero-quote-section" className="btn-primary">
                Get Free Quote
              </Link>
            </motion.div>
