...
import { FileText, Shield, Lock, AlertTriangle, CheckCircle, ExternalLink, Users, Heart } from 'lucide-react'
            ...
            <div className="container-custom">
                ...
                >
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 md:mb-6 px-4">
                        Terms of Use and <span className="gradient-text">Privacy Policy</span>
                    </h1>
                    <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto px-4">
                        Welcome to the website of Faith Hope Love Group ("Company," "we," "us," or "our"). These Terms of Use and Privacy Policy (collectively, "Agreement") form a legally binding agreement between you and Faith Hope Love Group, regarding your access to and use of our website and all related services.
                    </p>
                ...
                <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-red-700 text-sm md:text-base">
                                    By accessing or using the Site or Services, you confirm that you have read, understood, and agree to these Terms and our Privacy Policy. If you do not agree, you must not access or use the Site.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-600 mb-6 max-w-2xl mx-auto">
                            If you have any questions about these Terms of Use or our Privacy Policy, please don't hesitate to contact us.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                            <a href="/contact" className="btn-primary text-sm md:text-base">
                                Contact Us
                            </a>
                            <a href="/disclaimer" className="btn-secondary text-sm md:text-base">
