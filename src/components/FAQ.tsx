    ...
    questions: [
      {
        ...
        answer:
          "An insurance agency represents one or more insurers and offers policies to clients, helping them choose coverage that fits their needs.",
      },
      {
        question: "Do I need a license to operate an insurance agency?",
        answer:
          "Yes, each state requires agent and agencies to be licensed for specific lines of insurance.",
      },
      {
    ...
    questions: [
      {
        ...
        answer:
          "It typically covers medical expenses, hospital stays, and sometimes loss of income due to accidents or illnesses.",
      },
      {
        question:
          "Is Accident & Sickness insurance different from Health insurance?",
        answer:
          "Yes, it's usually a more limited, short-term policy focused on specific incidents.",
      },
      {
        question: "Can businesses offer this to employees?",
        answer:
          "Yes, many agencies provide group accident & sickness policies for employers.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "Casualty insurance generally covers liability for damages to other people or property, including auto, workers' comp, and general liability.",
      },
      {
        question: "Is casualty insurance required by law?",
        answer:
          "In many cases, yes—especially auto liability and workers' compensation.",
      },
      {
        question: "What businesses benefit most from casualty insurance?",
        answer:
          "Construction, transportation, and service-based businesses often require strong casualty coverage.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "Agencies offer term life, whole life, universal life, and variable life policies.",
      },
      {
        question:
          "Can life insurance be bundled with other types of insurance?",
        answer:
          "It depends on the insurer, but some offer packages or discounts when bundling with health or property insurance.",
      },
      {
        question: "Do life insurance policies require medical exams?",
        answer:
          "Some do, while others offer no-exam policies with limited coverage amounts.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "It includes damage to buildings, contents, and sometimes loss of income due to covered events like fire or theft.",
      },
      {
        question: "Can property insurance cover natural disasters?",
        answer:
          "Standard policies may exclude events like floods or earthquakes, which require add-ons.",
      },
      {
        question:
          "Is commercial property insurance different from homeowners insurance?",
        answer:
          "Yes, commercial policies are tailored to business operations and risks.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "It covers emergency medical expenses, accidental death, and trip interruption due to health issues during travel.",
      },
      {
        question: "Is this insurance valid internationally?",
        answer:
          "Yes, most policies are designed for international travel, but coverage can vary by region.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        question: "What Medicare plans do you offer?",
        answer:
          "We offer Medicare Advantage (Part C), Medicare Supplement (Medigap), and Prescription Drug Plans (Part D) to help you find the right coverage.",
      },
      {
        question: "How do I know which Medicare plan is right for me?",
        answer:
          "Our licensed agents will review your current prescriptions, healthcare needs, and budget to recommend the best plan for your situation.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "We notarize a wide range of documents including Powers of Attorney, Affidavits, Contracts, Real Estate Documents, Medical Directives, Immigration Forms, and Loan Documents.",
      },
      {
        question: "How much do notary services cost?",
        answer:
          "Our notary services are competitively priced. Contact us for specific pricing information based on your document type and requirements.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "We provide translation and interpretation services between French and English, including document translations and basic interpretation assistance.",
      },
      {
        question: "Do you provide certified translations?",
        answer:
          "We provide precise written translations that preserve the original meaning, tone, and context to ensure your documents remain legally and culturally appropriate.",
      },
    ],
  },
];
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">
            ...
            coverage options, and how we can help protect what matters most to
            you.
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`h-5 w-5 md:h-6 md:w-6 text-gray-500 transition-transform duration-300 ${
                          ...
                          {category.questions.map((item, questionIndex) => (
                            ...
                            >
                              ...
                              >
                                ...
                                <ChevronDown
                                  className={`h-4 w-4 md:h-5 md:w-5 text-gray-500 flex-shrink-0 transition-transform duration-300 ${
